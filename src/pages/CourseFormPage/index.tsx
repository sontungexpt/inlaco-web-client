...
import { BASE_FORM_VALUES, CERTIFICATED_COURSE_OPTIONS } from "./initial";
    ...
    try {
      ...
      const newCourse = await createCourse(
        mapValuesToRequestBody(values, {
          wallpaperAssetId: wallPaper.assetId,
          trainingProviderLogoAssetId: trainingProviderLogo.assetId,
        }),
      );
