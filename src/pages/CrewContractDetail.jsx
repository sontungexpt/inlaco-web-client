...
const CrewContractDetail = () => {
  ...
  const CREW_CONTRACT_SCHEMA = Yup.object().shape({
  ...
  return (
    <Formik
      ...
      validationSchema={CREW_CONTRACT_SCHEMA}
          ...
          <Grid container spacing={2} mx={2} rowSpacing={1} pt={2}>
            <Grid size={4}>
              <InfoTextField
                ...
                error={!!touched.partyA?.compName && !!errors.partyA?.compName}
                helperText={touched.partyA?.compName && errors.partyA?.compName}
                onChange={handleChange}
                onBlur={handleBlur}
                sx={{
          ...
          <Grid container spacing={2} mx={2} rowSpacing={1} pt={2}>
            <Grid size={3}>
              <InfoTextField
                ...
                error={!!touched.partyB?.fullName && !!errors.partyB?.fullName}
                helperText={touched.partyB?.fullName && errors.partyB?.fullName}
                onChange={handleChange}
                onBlur={handleBlur}
                sx={{
                  "& .MuiInputBase-input.Mui-disabled": {
            ...
            <Grid size={6}>
              <InfoTextField
                ...
                helperText={
                  touched.partyB?.permanentAddr && errors.partyB?.permanentAddr
                }
                onChange={handleChange}
                onBlur={handleBlur}
                sx={{
            ...
            <Grid size={6}>
              <InfoTextField
                ...
                helperText={
                  touched.partyB?.temporaryAddr && errors.partyB?.temporaryAddr
                }
                onChange={handleChange}
                onBlur={handleBlur}
                sx={{
            ...
            <Grid size={4}>
              <InfoTextField
                ...
                value={values.partyB?.ciNumber}
                error={!!touched.partyB?.ciNumber && !!errors.partyB?.ciNumber}
                helperText={touched.partyB?.ciNumber && errors.partyB?.ciNumber}
                onChange={handleChange}
                onBlur={handleBlur}
                sx={{
                  "& .MuiInputBase-input.Mui-disabled": {
          ...
          <Grid container spacing={2} mx={2} rowSpacing={1} pt={2}>
            ...
            <Grid size={3}>
              <InfoTextField
                ...
                error={!!touched.jobInfo?.endDate && !!errors.jobInfo?.endDate}
                helperText={touched.jobInfo?.endDate && errors.jobInfo?.endDate}
                onChange={handleChange}
                onBlur={handleBlur}
                sx={{
                  "& .MuiInputBase-input.Mui-disabled": {
